...
or just use string methods s.count(s[0]), which is the easiest 
...
## Final code string methods

Honestly, idk what is the significance of making the key disappear and whatever not
